 ...
 * @author xandy
 */
public class TelaManutencaoProdutos extends javax.swing.JFrame {

    /**
     * Creates new form Teste
     */
    public TelaManutencaoProdutos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 0, -1, 70));
        ...
        getContentPane().add(Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 70, 1050, 70));
        ...
        getContentPane().add(JButton_Comprar, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 520, 115, -1));
        ...
        getContentPane().add(JButton_Atualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 520, 115, -1));
        ...
        getContentPane().add(JButton_Deletar, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 520, 111, -1));

        JButton_Limpar.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        JButton_Limpar.setText("Buscar Produtos");
        JButton_Limpar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JButton_LimparActionPerformed(evt);
            }
        });
        getContentPane().add(JButton_Limpar, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 520, 140, -1));
        ...
        getContentPane().add(JButton_Cancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 520, 94, -1));
    ...
    private void JButton_ComprarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JButton_ComprarActionPerformed
        TelaDadosProduto teladosproduto = new TelaDadosProduto();
        teladosproduto.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaManutencaoProdutos().setVisible(true);
            }
        });
    }
